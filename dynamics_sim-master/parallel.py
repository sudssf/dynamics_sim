...
def wrapper_simulate(wrapper, num_gens, number_groups, group_size, rate, start_state=None, burn=0, class_end=False):
    """
    ...
    """
    return wrapper.simulate(num_gens=num_gens, number_groups=number_groups, group_size=group_size, rate=rate, start_state=start_state, graph=False, return_labeled=False, burn=burn, class_end=class_end)
