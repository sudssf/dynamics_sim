...
class TestCase(unittest.TestCase):
    ...
    #     s.simulate(num_gens=500, burn=100)
    ...
    #     s.vary_param('v', (20, 100, 1), num_gens=400, num_iterations=1, burn=399, graph=dict(area=True))
    ...
    #     s.vary_2params('v', (0, 5, 1), 'c', (1, 5, 1), num_iterations=1, num_gens=200, burn=199)
    #
