...
from games.payoff_matrices.humbly_signaling_matrices2 import senderPayoffs, receiverPayoffs
...
class HumblySignaling(Game):
    ...
    def classify(cls, params, state, tolerance):
        ...
        if state[3][3] > threshold and state[4][3] > threshold:
            return 0#Accept no one
        ...
        elif state[3][1] > threshold and state[4][2] > threshold:
